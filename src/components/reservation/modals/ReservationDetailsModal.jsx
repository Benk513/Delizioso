  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="outline">Detail Reservation</Button>
      </DialogTrigger>
      ...
      <DialogContent className="max-w-[1112px]">
        <DialogHeader>
          ...
          <img src={plate2}  width={200}alt="food image" />   
          </div>
          <h1 className="text-center font-bold text-2xl text-primary mb-2">Reservation detail</h1>
